...
const testTransactions = [
    { email: 'test@example.com', name: 'Test User', amount: '100.50' },
    { email: 'test@example.com', name: 'Test User', amount: '200.75' },
    { email: 'other@example.com', name: 'Other User', amount: '300.25' }
];
...
assert.strictEqual(determineSegment(601.5), 'Mid-Tier');
...
const expectedOutput = [
    { email: 'test@example.com', name: 'Test User', ltv: 301.25, segment: 'Low-Tier' },
    { email: 'other@example.com', name: 'Other User', ltv: 300.25, segment: 'Low-Tier' }
];
